...
costRouter.post('/login', async function (req, res, next) {
...
costRouter.post('/login/addProduct',async function(req, res, next){
...
costRouter.post('/login/report',async function(req, res, next){
